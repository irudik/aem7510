---
# Auto-rebuild: ls 04-non-competitive-output-markets/04-non-competitive-output-markets.Rmd | entr -c Rscript -e "rmarkdown::render('04-non-competitive-output-markets/04-non-competitive-output-markets.Rmd')"
title: "Lecture 4"
...
pacman::p_load(
  tidyverse, tidylog, xaringanExtra, rlang, patchwork, showtext
)
...
The last term doesn't equal zero so this FOC, given the second-best tax, cannot be equal to the first-best condition
